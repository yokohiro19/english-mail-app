        ...
        headers: [
          {
            ...
            value: [
              ...
              "frame-src 'self' https://checkout.stripe.com https://billing.stripe.com https://td.doubleclick.net https://www.googletagmanager.com https://accounts.google.com https://*.firebaseapp.com",
              "form-action 'self'",
              "base-uri 'self'",
              "object-src 'none'",

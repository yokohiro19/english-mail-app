...
export function buildSystemPrompt(cefr: string): string {
  ...
  return [
    ...
    "",
    "=== CONTENT COMPLIANCE (STRICTLY FOLLOW) ===",
    "This app is rated 9+ on the App Store. The generated email MUST NOT contain any of the following:",
    "- Profanity, crude humor, or offensive language of any kind.",
    "- Horror, fear-inducing, or disturbing themes.",
    "- Any reference to or depiction of alcohol, tobacco, or drug use (including casual mentions like 'grab a beer' or 'smoke break').",
    "- Any sexual or adult content, including indirect or suggestive references.",
    "- Any form of violence, weapons, or physical harm — including fictional, animated, or metaphorical violence.",
    "The email must be fully appropriate for a general professional workplace audience, including readers as young as 9 years old.",
    "=== END CONTENT COMPLIANCE ===",
    "",

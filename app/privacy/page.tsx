    ...
    <div className="landing">
      ...
      <section className="page-section">
        ...
        <div style={{ fontSize: 15, lineHeight: 1.9, color: "#374151" }}>
          ...
          <p>本サービスの運営者に関する情報（事業者名、所在地、電話番号、メールアドレス等）については、「<a href="/legal/tokushoho" style={{ color: "#2A3B6F" }}>特定商取引法に基づく表記</a>」ページをご参照ください。</p>
          ...
          <ul style={ulStyle}>
            ...
            <li>本サービスに関するお知らせおよびプロモーション情報のご案内（メール配信を含む）</li>
          </ul>
          ...
          <ul style={ulStyle}>
            <li>アカウント情報・学習履歴：法令対応、不正防止、紛争対応等に必要な期間（不正利用防止のため、退会後もメールアドレスから生成した照合用の不可逆的ハッシュ値を最大1年間保持します。保持期間経過後は自動的に削除されます）</li>

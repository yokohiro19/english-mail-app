    ...
    <div className="landing">
      ...
      <section style={{ padding: "120px 24px 80px", maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{ fontSize: 15, lineHeight: 1.9, color: "#374151" }}>
          ...
          <ul style={ulStyle}>
            <li>メールアドレス、パスワード（パスワードはハッシュ化等の不可逆的処理を施したもの）</li>
            <li>ニックネーム、学習設定情報</li>
            <li>学習履歴、利用状況</li>
          ...
          <p>当社は、本サービスの機能提供および品質向上のため、外部のAI関連サービス（例：OpenAI API 等）を利用することがあります。</p>
          <p>ユーザーが本サービス上で入力する情報は、当社が別途定める範囲に限定され、コンテンツ生成および配信制御の目的で、AI関連サービスに送信される場合があります。</p>

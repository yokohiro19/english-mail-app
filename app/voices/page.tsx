...
const voices = [
  {
    ...
    body: (
      <>
        <p>大学時代はTOEIC700点台をキープしていましたが、就職してから英語を使う機会が激減し、気づけば読むスピードも落ちてきていました。それでも仕事で突然英語のメールが届くことがあり、「ちゃんと続けなければ」という焦りはずっとありました。</p>
  ...
  },
  {
    ...
    stars: 5,
    body: (
      <p>「ちょうど楽しい難易度」という言葉に惹かれて始めました。やってみると、難しすぎず、簡単すぎず、本当にちょうどいい。達成感があるので、気づいたら3ヶ月続いていました。</p>
    ),
  },
];
